...
DROP TABLE IF EXISTS oms_sku CASCADE;;
DROP TABLE IF EXISTS oms_product CASCADE;;
DROP TABLE IF EXISTS oms_stock_log CASCADE;;
DROP TABLE IF EXISTS oms_ai_report CASCADE;;
